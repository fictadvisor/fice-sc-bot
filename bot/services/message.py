...
class MessageService:
    ...
    async def send_to_group(self, chat_id: int, title: str, message_id: int, from_chat_id: int,
        ...
        if message_in.media_group_id:
            ...
            await self._send_media_group(chat_id, title, username, media_group, None, thread_id)
        elif message_in.html_text:
            await self._send_text(chat_id, title, username, message_in.html_text, None, thread_id)
        else:
